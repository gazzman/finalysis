...
class AssetAllocation(Base):
    ...
    __table_args__ = {'schema':SCHEMA}
    ticker = Column(VARCHAR(21), ForeignKey('%s.tickers.ticker' % SCHEMA), primary_key=True)
...
class Equity(Base):
    ...
    equity_pct_long_non_us = Column(NUMERIC(19,4))
    equity_pct_long_us = Column(NUMERIC(19,4))
    equity_pct_short_non_us = Column(NUMERIC(19,4))
    equity_pct_short_us = Column(NUMERIC(19,4))
...
class FixedIncome(Base):
    ...
    fixed_income_pct_long_non_us = Column(NUMERIC(19,4))
    fixed_income_pct_long_us = Column(NUMERIC(19,4))
    fixed_income_pct_short_non_us = Column(NUMERIC(19,4))
    fixed_income_pct_short_us = Column(NUMERIC(19,4))
